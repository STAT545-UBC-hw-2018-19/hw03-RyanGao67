...
* From the plot above we can see that for most of the countries, lifeExp increases as the gspPercap increase. However, some countries has a period when the lifeExp decrease as the gdpPercap increase. 
